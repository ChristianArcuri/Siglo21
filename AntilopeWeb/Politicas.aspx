<%@ Page Title="" Language="C#" MasterPageFile="~/MasterGralNew.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="Politicas.aspx.cs" Inherits="AntilopeWeb.Politicas" %>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">						
            ...
            <div class="single-blog">							
				<h3 class="blog-title"><a href="#">INFORMACIÓN RELEVANTE </a></h3>							
            ...
            <div class="single-blog">							
				<h3 class="blog-title"><a href="#">LICENCIA </a></h3>							
				<div class="blog-description">
					<p>
                        Antilope S.A. a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
					</p>
				</div>				
			</div>
            <div class="single-blog">							
				<h3 class="blog-title"><a href="#">USO NO AUTORIZADO </a></h3>							
				<div class="blog-description">
					<p>
            ...
            <div class="single-blog">							
				<h3 class="blog-title"><a href="#">PROPIEDAD </a></h3>							
				<div class="blog-description">
					<p>
            ...
            <div class="single-blog">							
				<h3 class="blog-title"><a href="#">POLÍTICA DE REEMBOLSO Y GARANTÍA </a></h3>							
				<div class="blog-description">
					<p>
            ...
            <div class="single-blog">							
				<h3 class="blog-title"><a href="#">COMPROBACIÓN ANTIFRAUDE </a></h3>							
				<div class="blog-description">
					<p>
            ...
            <div class="single-blog">							
				<h3 class="blog-title"><a href="#">PRIVACIDAD </a></h3>							
				<div class="blog-description">
					<p>
                        ...
                        Antilope S.A. reserva los derechos de cambiar o de modificar estos términos sin previo aviso.<br />
					</p>
				</div>				
			</div>
        </div> 
